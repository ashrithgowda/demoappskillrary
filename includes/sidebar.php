...
<div class="row">
	<div class='box box-solid'>
	  	...
	  	<div class='box-body'>
	    	<a href="https://bit.ly/FSKILLRARY" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
	    	<a href="https://bit.ly/twitterSkillRary" class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>
	    	<a href="https://bit.ly/InstaSKILLRARY" class="btn btn-social-icon btn-instagram"><i class="fa fa-instagram"></i></a>
	    	<a class="btn btn-social-icon btn-google"><i class="fa fa-google-plus"></i></a>
	    	<a href="https://bit.ly/LISKILLRARY" class="btn btn-social-icon btn-linkedin"><i class="fa fa-linkedin"></i></a>
	  	</div>
	</div>
</div>
