...
<footer class="main-footer">
    <div class="container">
      ...
      <div class="col-md-4">
        <h5 class="join_our">Join Our Newsletter Now</h5>
        <p class="get_email">Get E-mail updates about our latest shop and special offers</p>
        <input type="text" class="inputSub" placeholder="Enter your mail">
